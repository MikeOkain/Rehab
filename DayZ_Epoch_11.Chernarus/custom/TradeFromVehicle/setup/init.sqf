...
call compile preprocessFileLineNumbers "custom\TradeFromVehicle\system\functions.sqf";
call compile preprocessFileLineNumbers "custom\TradeFromVehicle\system\variables.sqf";

sleep 0.5;

ExecVM "custom\TradeFromVehicle\monitor.sqf";