...
if (!isDedicated) then {
	...
	MaintainPlot		= compile preprocessFileLineNumbers "custom\plotManagement\maintain_area.sqf";
	PlotPreview			= compile preprocessFileLineNumbers "custom\plotManagement\plotToggleMarkers.sqf";
	PlotObjects			= compile preprocessFileLineNumbers "custom\plotManagement\plotObjects.sqf"; // NEW
	/*Plot End*/
	/*DoorManagement Zupa*/
...
player_switchModel = compile preprocessFileLineNumbers "custom\player_switchModel.sqf"; // DZGM
	...
	zombie_generate =     		compile preprocessFileLineNumbers "custom\zeds\zombie_generate.sqf";
	wild_spawnZombies =  		compile preprocessFileLineNumbers "custom\zeds\wild_spawnZombies.sqf";
...
player_wearClothes =		compile preprocessFileLineNumbers "custom\player_wearClothes.sqf"; // Fixed gear duping while changing clothes
	...
	//ui
player_selectSlot = compile preprocessFileLineNumbers "custom\ui_selectSlot.sqf"; // Right Click Menu
	...
	fnc_usec_damageVehicle =		compile preprocessFileLineNumbers "custom\vehicles\fn_damageHandlerVehicle.sqf";		//Event handler run on damage
	vehicle_handleDamage    = 		compile preprocessFileLineNumbers "custom\vehicles\vehicle_handleDamage.sqf";
	...
	fnc_veh_ResetEH = 			compile preprocessFileLineNumbers "custom\veh_ResetEH.sqf";			//Initialize vehicle
	// Vehicle damage fix
