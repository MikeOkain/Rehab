...
[_infiSZ] spawn {
        ...
        _startSafeZone =
        {
                ...
                {
                        _msg = 'You have entered a safezone!\n\nRunning people over,stealing, or griefing in a safezones will result in a ban!\nYOU HAVE BEEN WARNED!\n\nVehicles Left in safezone will be Teleported to the Junkyard on server Restart!';
                        hint _msg;
