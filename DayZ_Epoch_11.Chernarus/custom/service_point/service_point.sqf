...
_servicePointClasses = ["dayz_fuelpumparray","Land_A_FuelStation_Feed","Land_Ind_TankSmall","Land_Ind_TankSmall2","Land_Fuel_tank_big","Land_A_FuelStation_Build","Land_Ind_TankSmall2_EP1","Land_benzina_schnell","land_fuelstation_w"];
...
_rearm_costs = [
	...
	["AllVehicles",["ItemBriefcase100oz",2]]
];
