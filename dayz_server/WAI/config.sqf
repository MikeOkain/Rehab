if(isServer) then {
	...
	/* WAI MISSIONS CONFIG */
		...
		wai_mission_timer			= [0,900];						// time between missions 5-15 minutes
		...
		//Recon's Custom
		crate_items_buildables_large = ["forest_large_net_kit","cinder_garage_kit",["PartPlywoodPack",5],"ItemSandbagExLarge5X","park_bench_kit","ItemComboLock",["CinderBlocks",22],"ItemCanvas","ItemComboLock",["ItemLightBulb",5],"ItemLockbox",["ItemSandbag",2],["ItemTankTrap",5],["ItemWire",4],["MortarBucket",11],["PartPlankPack",5],"PartWoodPile",["metal_floor_kit",6]];
		crate_items_farmer   	     = ["cinder_garage_kit",["PartPlywoodPack",2],"park_bench_kit","ItemComboLock",["CinderBlocks",11],"ItemCanvas",["ItemLightBulb",2],"ItemLockbox",["ItemSandbag",2],["ItemTankTrap",2],["ItemWire",1],["MortarBucket",4],["PartPlankPack",2],["metal_floor_kit",2]];
		//Recon's Custom
