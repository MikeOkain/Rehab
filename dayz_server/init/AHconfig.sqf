...
[
	...
	"s_player_setVectors90","s_player_paint","DoorManagement","Entercode","ah1z_fold","ah1z_unfold","mv22_fold","mv22_unfold","mv22_open","mv22_close","suv_close","suv_open","uh1y_fold","uh1y_unfold"
];
/* ********************************************************************************* */
	//	NEW (EXPERIMENTAL):
